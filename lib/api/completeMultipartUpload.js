...
const { pushMetric, pushMetricV2 } = require('../utapi/utilities');
...
function completeMultipartUpload(authInfo, request, log, callback) {
    ...
    return async.waterfall([
        ...
        pushMetricV2('completeMultipartUpload', log, {
            authInfo,
            canonicalID: destinationBucket.getOwner(),
            bucket: bucketName,
            objectDelta: !generatedVersionId && oldByteLength !== null ? 0 : 1,
            sizeDelta: oldByteLength !== null ? oldByteLength : 0,
        });
