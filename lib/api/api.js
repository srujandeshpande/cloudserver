...
const api = {
    callApiMethod(apiMethod, request, response, log, callback) {
        ...
        return async.waterfall([
            ...
            log.info('tagConditionKeyAuth res', { userInfo, tagAuthResults, authorizationResults, updatedContexts });
            ...
            request.on('end', () => {
                ...
                // XXX we already checked auth, but without
                // request.post set, see how we can factorize to only
                // check conds once
