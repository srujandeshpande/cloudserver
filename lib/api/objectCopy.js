...
function objectCopy(authInfo, request, sourceBucket,
    ...
    return async.waterfall([
        ...
        const objectDelete = !isVersioned && destObjPrevSize !== null ? 0 : 1;
        const sizeDelta = isVersioned ? sourceObjSize : sourceObjSize - (destObjPrevSize || 0);

        pushMetricV2('copyObject', log, {
            authInfo,
